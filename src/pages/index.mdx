...
I have **{(new Date()).getFullYear() - 2011}+** _years of experience_ in application development.

My specialty is `Frontend Development` despite of earlier in my career, I was a desktop app developer.
